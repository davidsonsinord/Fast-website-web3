...
import com.davidson.controller.DomainController;
import com.davidson.service.DomainService;
...
public class DomainControllerTest {
    ...
    public void shouldGetDomainsOrGetDomainsByTitle() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/v1/domains")
        ...
        RequestBuilder requestBuilder2 = MockMvcRequestBuilders.get("/api/v1/domains?title=METHOD")
