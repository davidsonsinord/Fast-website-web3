    ...
    <v-card class="flex" flat tile>
      <v-card-title class="bg-turquoise-dav">
        <strong class="subheading"
          >Venez nous rejoindre sur les réseaux sociaux !</strong
        >
        ...
        <div>
          ...
          >
            <font-awesome-icon
              :icon="{ prefix: 'fab', iconName: link.icon }"
              size="2x"
            />
          </v-btn>
        </div>
      ...
      <v-card-actions class="grey darken-3 justify-center">
        <p>
          &copy;2019 —
          <strong
            ><a class="pr-3" target="_blank" href="https://www.davidson.fr/"
              >Davidson</a
            ></strong
          >
        </p>
        <p @click="$vuetify.goTo('#legal-anchor')">
